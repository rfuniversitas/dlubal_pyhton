...
class ObjectTypes(Enum):
    ...
    E_OBJECT_TYPE_MATERIAL, E_OBJECT_TYPE_SECTION, E_OBJECT_TYPE_POINT, E_OBJECT_TYPE_LINE, E_OBJECT_TYPE_PART, E_OBJECT_TYPE_OPENING = range(6)
...
class ElementType(Enum):
    ...
    '''
    TYPE_SINGLELINE, TYPE_ARC, TYPE_CIRCLE, TYPE_ELLIPSE, TYPE_PARABOLA = range(5)
